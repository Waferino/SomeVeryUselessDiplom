...
type Anceta () =
    ...
    member val name = defaultof<string> with get, set
    member val patron = defaultof<string> with get, set
    member val group = defaultof<string> with get, set
    member val birthdate = defaultof<string> with get, set
    member val grajdanstvo = defaultof<string> with get, set
    member val voinskii_uchet = defaultof<string> with get, set
    member val education = defaultof<string> with get, set
    member val family_status = defaultof<string> with get, set
    ...
    member val inn = defaultof<string> with get, set
    member val PFRF = defaultof<string> with get, set
    member val pIndex = defaultof<string> with get, set
    member val pRegion = defaultof<string> with get, set
    member val pCity = defaultof<string> with get, set
    member val pDistrict = defaultof<string> with get, set
    member val pStreet = defaultof<string> with get, set
    member val pHome = defaultof<string> with get, set
    member val pRoom = defaultof<string> with get, set
    member val fIndex = defaultof<string> with get, set
    member val fRegion = defaultof<string> with get, set
    member val fCity = defaultof<string> with get, set
    member val fDistrict = defaultof<string> with get, set
    member val fStreet = defaultof<string> with get, set
    member val fHome = defaultof<string> with get, set
    member val fRoom = defaultof<string> with get, set
    member val d_tel = defaultof<string> with get, set
    member val m_tel = defaultof<string> with get, set
    member val alter_lang = defaultof<string> with get, set
    member val Bonuses = defaultof<string> with get, set
    member val educationType = defaultof<string> with get, set
    member val dealNumber = defaultof<string> with get, set
    member val dealStartDate = defaultof<string> with get, set
    member val whoPay = defaultof<string> with get, set
    member val pastSport = defaultof<string> with get, set
    member val presantSport = defaultof<string> with get, set
    member val futureSport = defaultof<string> with get, set
    member val motherContact = defaultof<string> with get, set
    member val fatherContact = defaultof<string> with get, set